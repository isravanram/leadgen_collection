...
# Table name in your Airtable base
table_name = 'berkleyshomes_apollo'
table_object = Table(api_key, base_id, table_name)
...
def people_search(page_number,results_per_page):
  ...
  if response.status_code == 200:
      ...
      for contact in data['people']:
          ...
          data_org = contact
          airtable = Airtable('your_base_id', 'your_table_name')
          ...
          if enrichment_api_response.status_code == 200:
              ...
              export_to_airtable(table_object,data_dict)
